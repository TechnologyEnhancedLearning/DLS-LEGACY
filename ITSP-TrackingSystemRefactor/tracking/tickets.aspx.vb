...
Public Class tickets
    ...
    Protected Sub _SendHoldingEmailToTicketRaiser(ByVal nTicketID As Integer)
        ...
        sbBody.Append("In the meantime, it may speed up the resolution of your issue if you check the Digital Learning Solutions <a href=""https://www.dls.nhs.uk/tracking/faqs"">FAQS page</a> and <a href=""https://www.dls.nhs.uk/tracking/help/Introduction.html"">Help documentation</a> for assistance with your issue.<br/><br/>")
        sbBody.Append("Please note that most of the support requests that we receive can be resolved by ensuring that Shockwave Player is up-to-date and that https://www.dls.nhs.uk is in your Trusted Sites list.<br/><br/>")
