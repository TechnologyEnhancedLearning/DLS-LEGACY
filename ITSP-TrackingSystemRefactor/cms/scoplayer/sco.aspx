...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <title>ITSP SCO Content Player</title>
	<style type="text/css">
		* { margin: 0px; }
  html, body, form, iframe { height:100%; }
		html, body { overflow-y:auto; font-family:Helvetica, "Helvetica Neue", Arial; font-size:12px; }
    ...
    <tr>
      <td height="100%" valign="top">
       <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%" valign="middle" height="100%" valign="top"><div id="placeholder_contentIFrame" style="width:100%;height:100%;-webkit-overflow-scrolling:touch;"></div></td>
        </tr>
       </table>
      </td>
    </tr>
