<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="filemxsess.ascx.vb" Inherits="ITSP_TrackingSystemRefactor.filemxsess" %>
...
<script>
     ...
     <div class="card card-itsp-green m-2">
                <div class="card-header"><div class="row">
            <div class="col col-sm6">
<asp:Label ID="FilemxTitleLabel" runat="server" Text="Evidence Files"></asp:Label>
            </div>
...
<asp:Panel ID="pnlUpload" runat="server">
    <div class="card card-itsp-blue m-2">
