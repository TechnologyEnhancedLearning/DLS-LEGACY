Public Class filemxsess
    Inherits System.Web.UI.UserControl
    Public Property FilemxTitle As String
        Get
            Return FilemxTitleLabel.Text
        End Get
        Set(ByVal value As String)
            FilemxTitleLabel.Text = value
        End Set
    End Property
    ...
    Protected Sub bsucEvidenceUpload_FileUploadComplete(sender As Object, e As DevExpress.Web.FileUploadCompleteEventArgs)
        ...
        Else
            taFD.InsertFileInFileGroup(e.UploadedFile.FileName, e.UploadedFile.ContentType, e.UploadedFile.ContentLength, e.UploadedFile.FileBytes, Session("learnCandidateID"), Session("UserEmail"), Session("learnCurrentLogItemID"))
        End If
    End Sub
    ...
    Private Sub dsFiles_Selected(sender As Object, e As ObjectDataSourceStatusEventArgs) Handles dsFiles.Selected
        ...
        End If
        Dim nLogItemID = Session("learnCurrentLogItemID")
        Dim taq As New FilesDataTableAdapters.QueriesTableAdapter
